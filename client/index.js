...
window.onload = function () {
    if (localStorage.getItem("owner_save") === Owner) {
        document.getElementById('ifowner').innerHTML = "<p> After you submitted the form you can see your dog in the Dog Section by clicking Show More Dogs </p>"
    }    
        ...
        document.getElementById('f2').addEventListener('submit', async function (event) {
            ...
            try {
                ...
                if (document.getElementById("Tu2").checked == true) {
                    var x3 = document.getElementById("Tu2").value;
                    daysV.push(x3)
                }

                if (document.getElementById("W2").checked == true) {
                    var x4 = document.getElementById("W2").value;
                    daysV.push(x4)
                }

                if (document.getElementById("Th2").checked == true) {
                    var x5 = document.getElementById("Th2").value;
                    daysV.push(x5)
                }

                if (document.getElementById("F2").checked == true) {
                    var x6 = document.getElementById("F2").value;
                    daysV.push(x6)
                }
                if (document.getElementById("Sa2").checked == true) {
                    var x7 = document.getElementById("Sa2").value;
                    daysV.push(x7)
                }
                if (document.getElementById("Su2").checked == true) {
                    var x8 = document.getElementById("Su2").value;
                    daysV.push(x8)
                }
                dedV.push({
                    daysV : daysV,
                    access_token : 'hallumi'
                })
                //console.log(dedV)
        ...
        document.getElementById("percal").addEventListener('click', async function (event) {
                try {
                    userID = id;
                    document.getElementById('cal').style.display = 'block';
                    let error_appeared = false;
                    let response = await fetch('http://localhost:8090/loginCal/' + userID).catch(function(){
                        error_appeared = true;
            ...
            async function C() {
                try {
                    var error = false;
                    let response = await fetch('http://localhost:8090/showDogs').catch(function () {
                        error = true
